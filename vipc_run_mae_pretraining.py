...
def get_args():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='datasets/train_list2.txt', type=str,
                        help='dataset path')
    ...
    # new params
    parser.add_argument('--video_root', default="datasets/ShapeNetViPC-Dataset", type=str)
    parser.add_argument('--dataset_type', default='shapenet_vipc', type=str)
...
def main(args):
    ...
    num_training_steps_per_epoch = len(dataset_train) * args.repeated // args.batch_size // num_tasks
